                            ...
                            <div>
                                <div className='md:pl-10 pt-10'>
                                    <div className='flex flex-col pb-5 '>
                                        <span className='text-yellow-500 pb-1'><FormattedMessage id="User ID"/></span>
                                        <div className='border py-1'>
                                            <span className='text-gray-800 pl-2'>#34347</span>
                                        </div>
                                    </div>
                                    <div className='flex flex-col pb-5'>
                                        <span className='text-yellow-500 pb-1'><FormattedMessage id="Registration Date"/></span>
                                        <div className='border py-1'>
                                            <span className='text-gray-800 pl-2'>02/09/2024 15:45 </span>
                                        </div>
                                    </div>
                                    <div className='flex flex-col pb-5'>
                                        <span className='text-yellow-500 pb-1'><FormattedMessage id="Location:"/></span>
                                        <div className='border py-1'>
                                ...
                                <div>
                                    <div className='flex justify-evenly pt-5 pb-10 '>
                                        <div className='flex bg-red-500 px-8 py-1 rounded-lg shadow-2xl cursor-pointer'>
                                            <span className='px-2 pt-1 text-white'><RxCross2 /></span><button className='text-white'><FormattedMessage id="Cancel"/></button>
                                        </div>
                                        <div className='flex bg-[#83AF6F]  px-8 py-1 rounded-lg shadow-2xl cursor-pointer'>
                                            <span className='px-2 pt-1 text-white'><MdOutlineDone /></span><button className='text-white'><FormattedMessage id="Done"/></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
