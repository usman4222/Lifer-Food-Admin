...
const Dashboard = () => {
    ...
    return (
        <>
            <Wrapper>
                <Head heading={<FormattedMessage id="dashboard"/>} para={<FormattedMessage id="Registration Updates!"/>} />
                    ...
                    <div className="bg-white col-span-12 md:col-span-6 lg:col-span-4 mt-6 lg:mt-6 shadow-lg  flex flex-row justify-center items-center rounded-xl py-10 gap-x-6 ml-6 md:ml-6 lg:ml-0">
                        ...
                        <div className="flex justify-center items-center">
                            <div>
                                ...
                                <span className="text-[#464255] text-sm"><FormattedMessage id="Registered Accounts"/></span>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white col-span-12 md:col-span-6 lg:col-span-4 mt-6 lg:mt-6 shadow-lg  flex flex-row justify-center items-center rounded-xl py-10 gap-x-6 ml-6 md:ml-6 lg:ml-0">
                        ...
                        <div className="flex justify-center items-center">
                            <div>
                                ...
                                <span className="text-[#464255] text-sm"><FormattedMessage id="Pending Accounts"/></span>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white mt-6 col-span-12 md:col-span-6 lg:col-span-4 shadow-lg  rounded-xl gap-x-6 ml-6 md:ml-6 lg:ml-0">
                        <div>
                            <h6 className="text-center pt-5 font-bold text-[#464255]"><FormattedMessage id="Open Tickets"/></h6>
                        </div>
                        <div className="flex flex-row justify-center items-center pt-4 gap-x-12">
                            <div>
                                <div className="pb-5 lg:pb-0">
                                    <span className="text-[#F58201] text-sm font-bold"><FormattedMessage id="New Tickets"/></span>
                                    <h3 className="text-center font-bold text-2xl pt-3 text-[#464255] pb-5 md:pb-0">21</h3>
                                </div>
                            </div>
                            <div className="flex justify-center items-center">
                                <div className="pb-5 lg:pb-0">
                                    <span className="text-[#EA985B] text-sm font-bold"><FormattedMessage id="Pending Tickets"/></span>
                ...
                <div className="lg:ml-5 lg:mr-10 md:ml-2 lg:grid lg:grid-cols-12 pt-5">
                    <div className="pt-10 lg:col-span-9">
                        <div className="overflow-x-auto bg-white rounded-md mx-5 lg:grid lg:col-row-2 lg:mx-0">
                            <div className="w-full py-3 pl-4 border-b ">
                                <div className="text-left text-[#1E1E1E] font-bold md:text-xl"><FormattedMessage id="Graph"/></div>
                            </div>
                        </div>
                    </div>
                    <div className="p-5  md:flex md:justify-center lg:block lg:col-span-3 lg:flex-col lg:pt-10">
                        <div className="bg-white p-5 md:px-14 lg:px-0 rounded-lg shadow-lg">
                            <div>
                                <h5 className="font-extrabold	text-[#464255] text-lg pb-2 text-center md:pt-5 lg:pt-0"><FormattedMessage id="Sales Today"/></h5>
                                <h6 className="text-[#F58201] font-bold text-lg text-center pb-2"><FormattedMessage id="Premium"/></h6>
                                <div className="pt-2">
                                    <div>
                                    ...
                                    <div className="flex justify-center items-center pb-5">
                                        ...
                                        <span className="text-xs text-[#A3A3A3] pl-1"><FormattedMessage id="4% Yesterday"/></span>
                                    </div>
                                </div>
                            </div>
                            <hr className="my-1 border-t border-[#FFF4D9]" />
                            <div className="pt-5">
                                <h6 className="text-[#A3BB98] font-bold text-lg text-center pb-2"><FormattedMessage id="Manual"/></h6>
                                <div className="pt-2">
                                    <div>
                                        <h3 className="text-[#464255] text-3xl text-center font-extrabold pb-5">29</h3>
                                    </div>
